...
export default () => (
  <PageLayout>
    ...
    <Card title="Joining" bordered={false}>
      <p>
      Anna Helfers(from Germany) joined KhetiVirasat Mission (KVM)in August 2018 for a project on straw management in Punjab. The project was run by KVM,Center for Sustainable Agriculture (CSA) and the Swiss-based institute RanasMosler. Within the project Anna collected data for her master thesis in environmental psychology. She first joined KVM for some weeks at the head office in Jaitu before leaving for a 5 weeks journey through Punjab.
I spent two wonderful months working with KVM at Jaitu in a project on rice straw management in Punjab. In the following, I would like to share my experiences on arriving in India, staying at KVM and travelling through Punjab.
</p>
</Card>
