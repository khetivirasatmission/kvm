  ...
  <PageLayout>
    ...
    <Row gutter={18}>
      <Col xs={24} md={15} lg={15}>
        <Profile designation="" image={t2} />
      </Col>
      <Col xs={24} md={9} lg={9}>
        <Profile designation="" image={t1} />
      </Col>
    </Row>

    <Card
      title="TRINJAN: Rural Livelihoods through Traditional Skills"
      bordered={false}
    >
      <p>
        ...
        is being adopted in the last 5-6 decades didn’t allow women to enhance
        the collective working and its spread to the next generation. Younger
        generation is getting school and college education where these
        traditional creative skills are not considered worthy.
      </p>
      ...
      <p>
        ...
        to preserve this heritage, Organic Desi Cotton is being grown by the
        ...
        decorative products. All these skills have been promoted and developed
        under TRINJAN.
      </p>
      ...
      <p>
        ...
        people have been going through. These are socially and ecologically
        responsible products.
      </p>

      <blockquote>
        TRINJAN is Weaving the Social Fabric with Compassionate Warp and
        Dedicated Weft
      </blockquote>
    </Card>
    ...
    <Card title="Context" bordered={false}>
      <p>
        While working on this initiative for the past one year, KVM has found
        out a lot of artisans in the rural areas and those needs to be organized
        now. Following deliverables need to be completed within the duration of
        the project:
        <ul>
          <li>
            Doing a literature survey about the area for complete value chain
            starting from the cultivation of cotton to the finished product
          </li>
          <li>
            Proving a detailed report of the potential for the forward and
            backward linkages
          </li>
          <li>Assisting in developing an e-commerce platform for TRINJAN</li>
          <li>
            Preparing a consolidated report of the work done by the organization
          </li>
        </ul>
      </p>
    </Card>
    ...
    <Card title="Eligibility" bordered={false}>
      <p>
        Following criteria is suggestive and we are flexible and looking for
        young innovative minds.
        <ul>
          <li>Pursuing or completed graduation in any humanities stream.</li>
          <li>
            Interest in designing, textile making, marketing and arts and craft.
          </li>
          <li>
            Should have a strong interest in village handicrafts and
            understanding of agrarian crisis.
          </li>
          <li>
            Good knowledge of computer i.e. MS word, excel, power point and
            other relevant tools.
          </li>
          <li>
            Study might involve travel in local and distant places. Although
            this would be optional and based on convenience of the candidates.
          </li>
        </ul>
      </p>
    </Card>
    ...
    <Card title="Support from the organization" bordered={false}>
      <p>
        <ul>
          <li>
            Students will get a certificate and recommendation letter from the
            organization.
          </li>
          <li>
            It can be an opportunity for further collaboration as well. However,
            no stipend would be paid to the students for this engagement.
          </li>
        </ul>
      </p>
    </Card>
    ...
    <Card title="Selection" bordered={false}>
      <p>On the basis of online interview.</p>
    </Card>
...
export const Head: HeadFC = () => (
  <SEO title="Online Internship" description="" lang="en" />
);
