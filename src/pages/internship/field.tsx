  ...
  <PageLayout>
    ...
    <Card title="Context" bordered={false}>
      <p>
        ...
        now. Following information needs to be collected during the internship:
        <ul>
          <li>
            Getting a survey done in the villages where TRINJAN activities are
            going on in order to find out more details.
          </li>
          <li>
          ...
          <li>
            Meeting researchers and academicians who have already worked in this
            sector.
          </li>
          <li>
            Preparing a consolidated report of the work with nice pictures and
            other details.{" "}
          </li>
        </ul>
      </p>
    ...
    <Card title="Eligibility" bordered={false}>
      <p>
        ...
        <ul>
          ...
          <li>
            Should have a keen interest in village handicrafts and agrarian
            crisis.
          </li>
          <li>
            Good knowledge of computer i.e. MS word, excel, power point etc.
          </li>
    ...
    <Card title="Support from the organization" bordered={false}>
      <p>
        <ul>
          ...
          <li>
            If students can arrange for their travel well and good otherwise KVM
            will do the arrangements.
          </li>
          <li>
            Students will get a certificate however No extra stipend would be
            paid.
          </li>
          <li>
            To the students there can be an opportunity for further
            collaboration.
          </li>
        </ul>
      </p>
    ...
    <Card title="Positions Available" bordered={false}>
      <p>
        2-3 students would be needed at this point of time. We would do a small
        interview of the students in order to know them.
      </p>
    </Card>
...
export const Head: HeadFC = () => (
  <SEO title="On-field Internship" description="" lang="en" />
);
