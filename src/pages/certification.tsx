    ...
    <PageLayout>
      ...
      <Card title="Participatory Guarantee System" bordered={false}>
        <p>
          ...
          including producers and consumers and operate outside the frame work
          of third party certification. As per IFOAM (2008) definition
          ...
          stakeholders and are built on a foundation of trust, social networks
          and knowledge exchange”. PGS is a process in which people in similar
          situations (in this case small holder producers) assess, inspect and
          verify the production practices of each other and take decision on
      ...
      <Card title="Accreditation" bordered={false}>
        ...
        <p>
          <blockquote>
            KVM is authorized Regional Council for providing organic
            certification under Participatory Guarantee System in Punjab,
      ...
      >
        <p>
          In PGS organic farmers have full control over the certification
          process and are able to produce far more credible and effective system
          of quality assurance compared to third party certification. Important
        ...
        <p>
          <ol>
            ...
            <li>
              All the members are local and known to each other. Being
              themselves practicing organic farmers have high degree of
              understanding on day-to-day knowledge or acquaintance of the farm.
            </li>
            <li>
