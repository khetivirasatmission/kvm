  ...
  <PageLayout>
    ...
    <Card title="Introduction" bordered={false}>
      ...
      <p>
        ...
        fact. Therefore, from times immemorial, every community had its own ways
        of conserving, preserving and sharing the seeds. The seed diversity was
        religiously passed down to the generations who preserved it with
      ...
      <p>
        ...
        rice, each adapted to specific growing conditions and soil type; having
        distinct flavour & aroma; specified uses; medicinal properties and
        morphological characteristics.{" "}
      </p>
      <p>
        But, with the invasion of MNCs, Seed & Agro industries, this culture was
        brutally shattered and this wisdom was obliterated. Patented Hybrid
        seeds, which require high doses of chemicals, were introduced. These
        seeds, developed in laboratories with the aim of monopolising the global
        agriculture, were never able to match the vigour, vitality and life
        force energy of those developed naturally over centuries. The hybrid
        seeds captured the market in no time. Thus we lost the Seed Sovereignty.
        We lost the Seed Diversity, along with.
      </p>
    </Card>

    <Card title="Our Approach" bordered={false}>
      <p>
        Seeds are <strong>sentient entities</strong>, to be treated with respect
        and compassion. They can’t be monopolised to achieve the ulterior
        motives. From farmers, who sow the seeds systematically in their fields;
        to any individual who would randomly throw and allow them to grow in his
        backyard -{" "}
    ...
    <Card title="Our Initiatives" bordered={false}>
      ...
      <p>
        This idea mushroomed with the realisation that our kitchen gardeners had
        to look upon us every year to get the seeds. To make them independent,
        Seed Conservation became an integral part of our Kitchen Gardening
        workshops. Housewives, students, rooftop and urban gardeners eventually
        evolved as Seed Savers. Today we have{" "}
        <strong>110 Family Seed Banks</strong> –{" "}
        <em>
          sacred and cosy corners in the gardeners’ houses. Here, the seeds wait
          patiently till they go back into the soil and reap abundance.
        </em>
      </p>
      ...
      <p>
        ...
        conservation of indigenous seeds. Their classroom was a one-acre rented
        plot in Chaina village of Faridkot district. They were trained to manage
        the farm; grow organic & indigenous vegetables; conserve the seeds,
        preserve them with traditional practices and market them in various
        public events, under the auspices of KVM. These seeds were sold as ‘seed
        kits’, yielding an annual earning of 80,000 INR; which was distributed
      ...
      <p>
        ...
        food chain, environment and health. Nobody can prevent Genetic Pollution
        and Contamination caused by GM Crops.
      </p>
      <p>
        We owe the responsibility to create awareness among masses by exposing
        the under the table introduction of GM crops in India. We have initiated
        anti-GMO movement in Punjab which includes regular campaigns, public
        dialogues, experts' talks & seminars regarding:
        <ul>
          <li>
          ...
          <li>Failure of Bt Cotton in India and other GM crops in the world</li>
