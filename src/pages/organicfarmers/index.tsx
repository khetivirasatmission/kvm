...
import f2 from "../../images/farmers/jaspal-kaur.jpg";
import f3 from "../../images/farmers/jaspreet-kaur.jpg";
import f4 from "../../images/farmers/sukhjeet-kaur.jpg";
import f5 from "../../images/farmers/sukhpreet-kaur.jpg";
import f6 from "../../images/farmers/amarjeet-sharma.jpg";
  ...
  <PageLayout>
    ...
    <Row gutter={18}>
      <Col xs={24} md={24} lg={8}>
        <Link to="/organicfarmers/gurmeetbhawalpur"><Profile designation="Gurmeet Bhawalpur" image={f1} /></Link>
      </Col>
      <Col xs={24} md={24} lg={8}>
        <Link to="/organicfarmers/amarjeetsharma"><Profile designation="Amarjeet Sharma" image={f6} /></Link>
      </Col>
      <Col xs={24} md={24} lg={8}>
        <Link to="/organicfarmers/jaspalkaur"><Profile designation="Jaspal Kaur" image={f2} /></Link>
      </Col>
      <Col xs={24} md={24} lg={8}>
        <Link to="/organicfarmers/jaspreetkaur"><Profile designation="Jaspreet Kaur" image={f3} /></Link>
      </Col>
      <Col xs={24} md={24} lg={8}>
        <Link to="/organicfarmers/sukhjeetkaur"><Profile designation="Sukhjeet Kaur" image={f4} /></Link>
      </Col>
      <Col xs={24} md={24} lg={8}>
        <Link to="/organicfarmers/sukhpreetkaur"><Profile designation="Sukhpreet Kaur" image={f5} /></Link>
      </Col>
    </Row>
