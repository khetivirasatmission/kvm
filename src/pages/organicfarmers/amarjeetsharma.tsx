...
export default () => (
  <PageLayout>
    ...
    <Card title="" bordered={false}>
      ...
      <p><strong><em>What are the risks and dangers for NF?</em></strong></p>
      <p>Well, I think for natural farmers, right now, the government is more of a problem than a solution. Precisely because of all the incentives it gives to chemical farmers, and the almost nonexistent help provided to small natural farmers. So the risks and dangers for us are precisely coming from the government, especially given the influence that MNCs(Multi-national company) can have on it. And it also seems quite clear that the well-being of small farmer is no priority at all in these MNC’s agenda…</p>
      
      <p><strong><em>What are the next steps that you are going to take on your farm?</em></strong></p>
      <p>I would like to plant more trees, especially, fruit trees like jujube, peach, grape, papaya, banana, mango, orange and pear. I am planning to achieve this progressively over the next few years.”
      </p>
    </Card>
