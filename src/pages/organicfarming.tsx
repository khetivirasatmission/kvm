...
export default () => (
  <PageLayout>
    ...
    <Card title="Introduction" bordered={false}>
      ...
      <p>In order to educate, sensitize and train farmers in organic farming, we organise regular Workshops, Seminars, Public dialogues, Farm visits and  Participatory Resource Appraisals. Our team of experts, from all over the country, is always ready to help and guide our farmers. </p>
    </Card>
    ...
    <Card title="Our Initiatives" bordered={false}>
      ...
      <p>
        ...
        <ul>
          <li>Various organic practises like cow-based farming, permaculture, Amrut Krishi, no-till farming, forest-farming and the like</li>
          ...
          <li><Link to="/organickitchengardening"><strong>Kitchen Gardening</strong></Link></li>
          <li>Food processing  </li>
          <li>Storage and <Link to="/organicfarmersmarket"><strong>Marketing</strong></Link>  </li>
          <li><Link to="/certification"><strong>Public Guarantee Scheme (PGS) certification</strong></Link> </li>
        </ul>
      </p>

      <h4>Awareness meetings</h4>
      <p>
        To connect with masses, we have organized <strong>over 3000 meetings</strong> so far, covering almost every district of Punjab. These meetings are particularly held to make people aware of the <i>‘Crisis of Civilization’</i> (Harmful effects of pesticides, lack of nutrition in diet, destruction of the environment etc.)  which has devastated the state.
      </p>

      <h4>Seminars & Expert Talks </h4>
      <p>
        These are our topic specific meetings where we host subject matter experts from across the country. We cover rural as well as urban audiences. The topics range from holistic health to crop residue management. We have conducted over <strong>500 such seminars</strong> to date. We also have a dedicated <strong>Environment Health Action</strong> group, comprising of medical and environmental health professionals. We have conducted over 50 such talks under the umbrella of this group.
      </p>

      <h4>Model Farm schools</h4>
      <p>
        This is a novel, one of a kind concept, where hands-on training is given to the interested farmers who wish to adopt organic farming. <strong>Over 100</strong> of these ‘Schools’ are established across the state. The trainings happen on the field of the master trainer.
      </p>
    ...
    <Card title="Meet our Farmers" bordered={false}>
      <p>In late 90s, when the concept of Organic Farming was first introduced in Punjab by a small team of KVM, led by Shri Umendra Dutt, there was not even a speck of agricultural land free from poisons. The idea which was then alien to the farmers and thus rejected, is now in vogue in the state. But this was achieved with a great deal of patience, perseverance and determination. KVM sowed the seeds, nurtured and multiplied them with care and compassion and, therefore, today we have a wide network of farmers practising natural farming across Punjab, under the guidance of KVM.</p>
      <p>Initially taking baby steps, we have evolved with our farmers; and now, together with them, we are taking quantum leaps.</p>
      <p>We are honoured to share the <Link to="/organicfarmers">Stories of Evolution</Link> of our farmers. These are the milestones in the journey of Kheti Virasat Mission as an ever-expanding family. </p>
    </Card>

    <Card title="Get Involved" bordered={false}>
      <p><Link to="/kudratikhetigurukul"><strong>Participate</strong></Link> in the Upcoming Events, trainings and workshops.</p>
      <p>
        <Link to="/kudratikhetigurukul"><strong>Initiate</strong></Link> seminars, meetings, awareness campaigns & farmers’ talks with KVM in your area.</p>
      <p><Link to="/volunteer"><strong>Volunteer</strong></Link> in various Activities</p>
      <p><Link to="/kudratikhetigurukul"><strong>Learn</strong></Link> hands-on under the guidance of Master Trainers on their ‘Model Farm Schools'.</p>
      <p><Link to="/donate"><strong>Donate</strong></Link> to help us support our organic farmers;  facilitate regular trainings;  develop model farms;  conduct surveys for maintaining data base and more. </p>
    </Card>
