    ...
    <PageLayout>
      ...
      <Card title="Campaigns against GM food" bordered={false}>
        <p>
          ...
          pigs with his plan to introduce Bt. Brinjal in India. The success of
          the campaign in Punjab and across the Nation can be seen from the fact
          that Jairam Ramesh, the then Environment and Forests Minister had
          declared moratorium on the introduction of bt. brinjal.
        </p>
      </Card>
      ...
      <Card title="Campaigns against pesticides undertaken" bordered={false}>
        <ol>
          ...
          <li>
            ...
            Muktsar, Bathinda, Mansa and Sangrur districts. Eminent water
            warrior Rajinder Singh led this Yatra.
          </li>
      ...
      <Card title="Surveys and Field studies undertaken" bordered={false}>
        <ol>
          ...
          <li>
            Field study on Reproductive Health in Jajjal, Chaina, Dabrikhana,
            Jida and Bhotna
          </li>
          ...
          <li>
            Field investigation on impact of Bt cotton on animal health in
          ...
          <li>
            Field study of Water Crisis and Water Contamination alongwith
            Ghahhar river in Patiala and Sangrur districts
          </li>
          <li>
          ...
          <li>
            ...
            destruction of Soil, Ecology and Health and its economic
            implications
          </li>
        </ol>
...
export const Head: HeadFC = () => <SEO title="Advocacy and Campaigns" />;
