  ...
  return (
    <PageLayout>
      ...
      <p>
        ...
        <strong>'Garden for Anyone Anywhere'</strong>. Be it a small patch in
        your backyard, some pots on the window sill or children’s playground,
        our team will help you to apply a bit of the creativity and innovation
        to grow food.
      </p>
      ...
      <Card title="Choose Your Garden" bordered={false}>
        ...
        <p>
          Choose a garden that suits you the most. And, we will grow it
          Together.
        </p>

        <h4>Backyard Garden</h4>
        <p>
          If you are planning to convert the land in your backyard into a
          garden, we will help you design it. Grow a beautiful canvas of trees,
          herbs, flowers and vegetables; and invite birds, insects, butterflies
          and bees all throughout the year. The garden will be a thing of beauty
        ...
        <p>
          ...
          microgreens, herbs and vegetables in hanging baskets, containers and
          on trellises by selecting the suitable candidates that require less
          space.
        </p>
        ...
        <p>
          ...
          community garden where the space, resources, labour and the produce
          are shared. Beside being a place for recreational activities, such
          gardens can become the hubs for social interaction. The culture of
          Giving, Sharing, Togetherness, Brotherhood and Harmony which is rare
          to be found, can be re-established in the communities.
        </p>

        <h4>School Garden</h4>
        <p>
          With their hands in the dirt, heads in the sun and hearts in the
          nature, children should emerge as a young gardeners. Allowing them to
          understand and appreciate how the food is grown, is their initiation
          into sustainable and natural living. We work with educational
          institutions to grow food on terraces, sidewalks and grounds with
      ...
      <Card title="Let’s Begin" bordered={false}>
        ...
        <ul>
          <li>
            ...
            diversity; taking into account all the geographical and
            topographical factors.{" "}
          </li>
          <li>
            <strong>Training the gardener :</strong> The gardener will be
            trained in soil preparation composting, bio fertilizers, pest
            management, waste management, seed conservation etc. This shall
            happen either through one on one teachings or attending KVM's
            Organic Kitchen Gardening workshops at your nearest locale.
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>
            <small>
              The terms will be laid in accordance to the specific requirements
              of individuals
            </small>
          </li>
        </ul>
...
export const Head: HeadFC = () => <SEO title="Design your garden" />;
