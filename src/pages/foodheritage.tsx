    ...
    <PageLayout>
      ...
      <Card title="Serving Traditional Punjabi Food" bordered={false}>
        <p>
          ...
          Purpose of this group is to revive not only traditional Punjabi food
          but also nutritious and health food.
        </p>
      </Card>

      <Card title="Relish dishes from the past" bordered={false}>
        <p>
          Menu is basically based on traditional Punjabi items that include -
        </p>
        <ul>
          ...
          <li>Snacks</li>
          <li>
            Diffrent Sharbats- Falsa, Pudina, Gudh, Thandiyai, Sharbat-e-Jigar
            and many more
          </li>
        </ul>
...
export const Head: HeadFC = () => <SEO title="Revival of Food Heritage" />;
