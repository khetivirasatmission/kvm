...
const Page: React.FC<PageProps> = () => {
  return (
    <PageLayout>
      ...
      <Card
        title="Collaborative Initiative of Organic Farmers"
        bordered={false}
      >
        <p>
          ...
          costumers here, we regard them as environmental activists and
          supporters of Organic Farming movement. These consumers are partners
          in a collective effort to bringing Punjab out of ecological crisis.
          They are performing their environmental duties to protect Nature and
          Food and to Make this Earth livable for our future generations.
        </p>
      </Card>

      <Card title="Commitment of Quality" bordered={false}>
        <p>
          Kudrati Aahar Parivar understands that as the quality of the crops
          grown by natural farmers, and the products prepared from them is not
          an accident, but the degree of excellence or superiority, is a
          combination of attributes of growing techniques, properties of such
          foods, or characteristics that give each commodity value in terms of
          its intended use with respect to the Size, Shape, Color, Gloss,
          Sweetness, Sourness [Acidity], Astringency, Bitterness, Aroma,
          Firmness, Crispiness, Juiciness, Mealiness, Toughness as well as
          Off-flavourness, Defects and decay beside the Nutritional factors as
          Vitamins (C,A,B, Thiamine, Niacin), Minerals, Dietary Fiber, Fat, Oil,
          Carotenoids, Flavonoids, Sterols and Antioxidants. This also involves
          the manufacturing processes.
        </p>

        <ul>
          <li>
            All products are grown organically/naturally without any chemicals
          ...
          <li>
            ...
            organic bazars where the farmers and consumers are brought together
            in a lively and chemical free atmosphere every week
          </li>
        </ul>
      </Card>
    </PageLayout>
...
export const Head: HeadFC = () => <SEO title="Kudrati Aahar Parivar" />;
