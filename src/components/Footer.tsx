...
const Footer = () => (
  ...
  >
    <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-12 lg:px-8">
      <div className="xl:grid xl:grid-cols-3 xl:gap-8">
        <div className="space-y-8 xl:col-span-1">
          <img className="w-24" src={logo} alt="Kheti Virasat Mission" />
          <p className="text-base text-gray-500">
            Ecological reconstruction of Punjab through organic farming and
          ...
          <div className="flex space-x-6">
            ...
            <a
              href="https://www.instagram.com/kvm_punjab/?hl=en"
              className="text-gray-400 hover:text-gray-500"
              target="_blank"
            >
            ...
            <a
              href="https://twitter.com/khetivirasatmis"
              className="text-gray-400 hover:text-gray-500"
              target="_blank"
            >
            ...
            <a
              href="https://m.youtube.com/user/khetivirasatmission"
              className="text-gray-400 hover:text-gray-500"
              target="_blank"
            >
        ...
        <div className="grid grid-cols-2 gap-8 mt-12 xl:col-span-2 xl:mt-0">
          <div className="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3 className="text-base font-medium text-gray-900">Our Work</h3>
            ...
            <div className="mt-12 md:mt-0">
              ...
              <ul role="list" className="mt-4 space-y-4">
                <li>
                  <a
                    href="/kudratikhetigurukul/"
                    className="text-base text-gray-500 hover:text-gray-900"
                  >
                    Kudrati Kheti Gurukul
                  </a>
                </li>
    ...
    <div className="w-full py-8 border-t border-gray-200">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <p className="text-base text-gray-400 xl:text-center">
          &copy; {new Date().getFullYear()} Kheti Virasat Mission. All Rights
          Reserved.
        </p>
      </div>
    </div>
